...
/*
status: "Invoiced and Delivered",
actualPickupDate: "2019-03-06T14:00:00.000-08:00",
actualDeliveryDate: "2019-03-12T11:15:00.000-07:00",
originCity: "LEES SUMMIT, MO",
destinationCity: "ALBANY, OR",
searchCriteria: "50762C09"
*/

/*
request.onload = function() {
    var myArr = request.response;
    console.log(myArr);
    gotData(myArr);
};
*/
...
function setup() {
  ...
  button.mousePressed(referenceAsk);

  input = select('#searchCriteria');
  //input = select('#city');
}

function referenceAsk() {
